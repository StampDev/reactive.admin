...
define(["require", "exports", 'react', '../../../core/lib', 'react-bootstrap', '../lib/emp_explorer', './emp_job_roles'], function (require, exports, React, jx, rb, emp_explorer_1, emp_job_roles_1) {
    ...
    var EmpProfessionalInfo = (function (_super) {
        ...
        EmpProfessionalInfo.prototype.render = function () {
            var html = React.createElement("div", null, React.createElement("div", {className: "row"}, React.createElement("div", {className: "col-lg-12"}, React.createElement("div", {className: "m-b-md"}, React.createElement("h2", null, "Professional profile")))), React.createElement(b.Row, null, React.createElement(b.Col, {lg: 12}, React.createElement(EmpStatistics, null))), React.createElement("div", {className: "row"}, React.createElement("div", {className: "col-lg-12"}, React.createElement(jx.views.TabControl, null, React.createElement(b.Tabs, {defaultActiveKey: 1, id: "tabs"}, React.createElement(b.Tab, {eventKey: 1, title: "Experience history"}, React.createElement("br", null), React.createElement(emp_job_roles_1.EmpJobExplorer, {owner: this, start_by_loading: true, emp: this.props.emp})), React.createElement(b.Tab, {eventKey: 2, title: "Activities"}, React.createElement("br", null), React.createElement(EmpActsExplorer, {owner: this, emp: this.props.emp, usr: this.props.usr})), React.createElement(b.Tab, {eventKey: 3, title: "Skills"}, React.createElement("br", null), React.createElement(EmpSkillsExplorer, {owner: this, emp: this.props.emp, usr: this.props.usr})))))));
            return html;
        };
    ...
    var EmpActsExplorer = (function (_super) {
        ...
        EmpActsExplorer.prototype.get_exec_paging = function (dt, req, draw, setts) {
            ...
            var exclude_ids = _.map(dt.props.exclusions, function (a) { return _.result(a, 'actid'); });
