...
define(["require", "exports", 'react', '../../core/lib'], function (require, exports, React, jx) {
    ...
    var InsWrapperContent = (function (_super) {
        ...
        InsWrapperContent.prototype.render = function () {
            var html = React.createElement("div", {className: "row"}, React.createElement("div", {className: "col-lg-12"}, React.createElement("div", {className: "wrapper wrapper-content"}, this.state.content)), React.createElement("div", {className: "footer fixed"}, React.createElement("div", {className: "pull-right"}, "10GB of ", React.createElement("strong", null, "250GB"), " Free."), React.createElement("div", null, React.createElement("strong", null, "Copyright"), " Example Company © 2014-2015")));
            //
            return html;
        };
        InsWrapperContent.prototype.componentWillMount = function () {
            ...
            jx.pubsub.subscribe('onSetcontent', function (msg, args) {
                _this.setState(_.extend(_this.state, args), function () {
                });
            });
        };
